...
public:
    ...
    void setupUi(QMainWindow *USBIOBoard)
    {
        ...
        label_11->setGeometry(QRect(490, 20, 21, 21));
        ...
        label_4->setGeometry(QRect(65, 20, 21, 21));
        ...
        label_analogv_1->setGeometry(QRect(280, 30, 46, 21));
        QFont font3;
        ...
        label_analogv_2->setGeometry(QRect(280, 70, 46, 21));
        ...
        label_analogv_3->setGeometry(QRect(280, 110, 46, 21));
        ...
        label_19->setGeometry(QRect(10, 140, 151, 21));
        ...
        label_17->setGeometry(QRect(10, 20, 71, 21));
