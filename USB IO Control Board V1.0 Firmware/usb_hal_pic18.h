...
typedef union _BD_STAT
{
    ...
    struct{
        ...
        // the values
		#if defined(PICC18PORT)
			// ANSI says you cannot have two labels the same in a union
			// so BC8, BC9 and UOWN are removed and left as padding.
	        unsigned :1;         //bit 8 of the byte count
	        unsigned :1;         //bit 9 of the byte count
	        unsigned PID0:1;     //Packet Identifier
	        unsigned PID1:1;
	        unsigned PID2:1;
	        unsigned PID3:1;
	        unsigned :1;
	        unsigned :1;        //USB Ownership
		#else
	        unsigned BC8:1;         //bit 8 of the byte count
	        unsigned BC9:1;         //bit 9 of the byte count
	        unsigned PID0:1;        //Packet Identifier
